function KellyThreadWork(cfg) {
    ...
    var validateResponseMethod = 'body';
    ...
    this.updateCfg = function(cfg) {
        ...
        if (typeof cfg.validateResponseMethod != 'undefined') {
            validateResponseMethod = cfg.validateResponseMethod;
        }
    ...
    function applayJob() {
        ...
        var defaultCallback = function(urlOrig, data, errorCode, errorText, controller) {
            ...
            if (data !== false) {
                thread.response = validateResponseMethod == 'body' ? KellyTools.validateHtmlDoc(data) : data;
            } else {
