...
function KellyGrabber(cfg) {
    ...
    this.TRANSPORT_BLOBBASE64 = 1002; // for bad designed browsers that cant catch blob url from front sended to background (currently problem in firefox)
    
    var transportMethod = handler.TRANSPORT_BLOB; // TRANSPORT_BLOBBASE64;
