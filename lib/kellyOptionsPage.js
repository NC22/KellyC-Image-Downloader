...
KellyOptionsPage.init = function() {
    ...
    K_FAV = new KellyFavItems({env : KellyProfileJoyreactor.getInstance(), location : location});
    ...
    // KellyOptionsPage.env.webRequestsRules.hostList.push(window.location.host);
    ...
    KellyTools.getBrowser().runtime.sendMessage({method: "getResources", items : ['options']}, onLoadOptionsCss); // KellyOptionsPage.env.profile
}
