...
KellyOptionsPage.init = function() {
    ...
    K_INIT_HOOK = function() {
        ...
        K_FAV = new KellyFavItems(false); // todo set context name        
        KellyTools.DEBUG = true;
        
        KellyOptionsPage.env = K_FAV.getGlobal('env');        
        KellyOptionsPage.env.hostClass = 'options';
...
KellyOptionsPage.showProfileSandbox = function() {
    ...
    var sandboxContainer = document.getElementById('page-sandbox');
    ...
    KellyTools.setHTMLData(sandboxContainer, sandboxHtml);
}