...
KellyOptionsPage.init = function() {
    ...
    KellyGrabber.REGISTER_WEBREQUESTS = false;   
    ...
    KellyOptionsPage.env.events.onExtensionReady = function() {
        ...
        // constant cors / referer controller 
        
        KellyTools.getBrowser().runtime.sendMessage({ method : 'register.Downloader', state : 'download', 
            referrer : KellyOptionsPage.env.location.protocol  + '//' + KellyOptionsPage.env.location.domain + '/',
            cors : true,
            optionsTab : true,
        }, function() {});
