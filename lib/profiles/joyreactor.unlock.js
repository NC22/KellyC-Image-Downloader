var KellyProfileJoyreactorUnlock = {
    ...
    tplItems : ['att-image', 'att-youtube', 'att-coub', 'query', 'query-post', 'query-post-with-comments', 'post', 'comment', 'post-form-comment', 'post-form-vote', 'comment-form-vote'],
    ...
    getCensored : function() {
        ...
        for (var i = 0; i < publications.length; i++) {
            ...
            if (publications[i].innerHTML.indexOf(this.handler.className + '-censored') != -1) continue;
            if (publications[i].innerHTML.indexOf('/images/censorship') != -1 || publications[i].innerHTML.indexOf('/images/unsafe_ru') != -1) censored.push(publications[i]);
        }       
