var KellyProfileJoyreactorUnlock = {
    ...
    formatCensoredPost : function(postBlock) {
        ...
        if (self.options.unlock.censoredMode == 'auto' && !self.unlockPool.request) { // can be beasy in some cases - ex. if too many mutations called on page during ajax pagination
