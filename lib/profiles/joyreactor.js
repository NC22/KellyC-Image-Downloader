...
function KellyProfileJoyreactor() {
    ...
    this.formatPostContainer = function(postBlock) {
        ...
        if (coptions.unlock.censored && typeof KellyProfileJoyreactorUnlock != 'undefined') KellyProfileJoyreactorUnlock.formatIfCensored(handler, postBlock, coptions.unlock.censoredAuto);
