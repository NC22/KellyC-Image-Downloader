...
function KellyProfileJoyreactor() {
    ...
    this.events = {
        ...
        */     
        ...
        onExtensionReady : function() {
            ...
            if (typeof KellyProfileJoyreactorUnlock != 'undefined') KellyProfileJoyreactorUnlock.init(handler);
    ...
    this.getFavPageInfo = function() {
        ...
        var info = {
            ...
            route : false,
            url : false,
            contentName : 'grabbedData', // url decoded, todo - rename - Tag name or User name
            contentImg : false,
            censoredNum : 0,
        }      
        ...
        info.items = handler.getPosts().length;
        ...
        if (pagination) { 
            ...
            for (var i = 0; i < pages.length; i++) {
                ...
                if (info.url === false && pageUrlInfo) info.url = pageUrlInfo.tpl;
