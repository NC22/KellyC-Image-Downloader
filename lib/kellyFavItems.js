    ...
    */
    ...
    this.onDownloadNativeFavPage = function(worker, thread, jobsLength) {
        ...
        for (var i = posts.length - 1; i >= 0; i--) {         
            ...
            if (!selectedImages.length && typeof KellyProfileJoyreactorUnlock != 'undefined' && KellyProfileJoyreactorUnlock.formatIfCensored(env, selectedPost) === true) {
        ...
        if (pageInfo.censoredPostIds.length) {
