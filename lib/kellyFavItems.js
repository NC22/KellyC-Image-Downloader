    ...
    */
    ...
    this.onDownloadNativeFavPage = function(worker, thread, jobsLength) {
        ...
        for (var i = posts.length - 1; i >= 0; i--) {         
            ...
            if (!selectedImages.length && favNativeParser.unlockRequests !== false && KellyProfileJoyreactorUnlock.isCensored(selectedPost) === true) {
    ...
    this.getBookmarksParser = function() {
        ...
        if (typeof KellyProfileJoyreactorUnlock != 'undefined' && fav.coptions.unlock.censored) {
    ...
    this.showNativeFavoritePageInfo = function() {
        ...
        if (favPageInfo.unlockRequests !== false) KellyProfileJoyreactorUnlock.initWorkspace();
