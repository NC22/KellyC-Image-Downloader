...
function KellyFavItems(cfg) 
{
    ...
    var mode = 'main'; // todo - make public methods, current extension page, main - not in extension, fav - show favourites page
    ...
    */  
    ...
    function constructor(cfg) {
        ...
        if (cfg.webRequestsRules) handler.webRequestsRules  = cfg.webRequestsRules;
        else handler.webRequestsRules = {
                state : 'download', 
                referrer : env.location.protocol  + '//' + env.location.domain + '/',
                cors : true
            };
            
        if (cfg.webRequestsDisabled) handler.webRequestsDisabled = true;
        ...
        imageGrid = new KellyTileGrid({
            ...
            events : {
                ...
                onResizeImage : function(self, itemInfo) {
                    ...
                    if (!itemInfo.tile || !itemInfo.boundEl || itemInfo.boundEl.tagName != 'IMG') return;
    ...
    */
    ...
    this.hideFavoritesBlock = function() {
        ...
        KellyTools.classList('remove', envContainers.favContent, 'active');
    ...
    function displayFavouritesBlock(newMode) {
        ...
        KellyTools.classList('add', envContainers.favContent, 'active');
    }
    ...
    this.initWebRequestRules = function(data) {        
        if (!data) data = handler.webRequestsRules;  
    ...
    this.initResources = function() {
        ...
        KellyTools.getBrowser().runtime.sendMessage({method: "getResources", items : ['main', env.profile]}, function(request) {
            ...
            } else if (!handler.webRequestsDisabled) handler.initWebRequestRules(false);
