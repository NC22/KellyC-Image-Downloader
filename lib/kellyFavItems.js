...
function KellyFavItems(cfg) 
{
    ...
    */
    ...
    function getSelectedPostMediaControlls() {
        ...
        KellyTools.getElementByClass(controlls, env.className + '-PreviewImage-prev').onclick = function() { return handler.switchPreviewImage(-1); }
        KellyTools.getElementByClass(controlls, env.className + '-PreviewImage-next').onclick = function() { return handler.switchPreviewImage(1); }
        KellyTools.getElementByClass(controlls, env.className + '-PreviewImage-del').onclick = function() { return handler.switchPreviewImage(0); }
