    ...
    */
    ...
    this.onDownloadNativeFavPage = function(worker, thread, jobsLength) {
        ...
        for (var i = posts.length - 1; i >= 0; i--) {         
            ...
            if (fav.coptions.unlock.censoredParser && !selectedImages.length && KellyProfileJoyreactorUnlock.formatIfCensored(selectedPost) === true) {
        ...
        if (fav.coptions.unlock.censoredParser && pageInfo.censoredPostIds.length) {
            ...
            var unlockRequest = KellyProfileJoyreactorUnlock.unlockPostList(pageInfo.censoredPostIds, KellyProfileJoyreactorUnlock.getTpl('query-post'), function(rids, unlockedData) {
                ...
                for (var i = 0; i < pageInfo.censoredPostIds.length; i++) {
                    ...
                    KellyTools.setHTMLData(pageInfo.censoredPosts[blockPostId].post, KellyProfileJoyreactorUnlock.getTpl('post', {PICS : KellyProfileJoyreactorUnlock.getPublicationAttributesHtml(blockPostData.attributes)}));    
