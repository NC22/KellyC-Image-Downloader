...
function KellyOptions(cfg) {
    ...
    this.tabData['Other'].parts = { 
        _common : ['unlockCensored', 'mobileOptimization', 'darkTheme', 'optionsSide', 'hideTopMenu', 'debug', 'webRequest', 'baseFolder'],
    };
    ...
    this.cfgInput = {     
        ...
        'unlockCensored' : {name : 'unlockCensored', loc : 'unlock_censored', type : 'bool', default : true},
