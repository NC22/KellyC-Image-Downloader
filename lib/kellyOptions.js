...
function KellyOptions(cfg) {
    ...
    this.cfgInput = {     
        ...
        'unlock_unlockCensored' : {name : 'censored', parent : 'unlock', loc : 'unlock_censored', type : 'bool', default : true},
        'unlock_unlockCensoredAuto' : {name : 'censoredMode', parent : 'unlock', loc : 'unlock_censored_mode', listLoc : ['unlock_censored_auto', 'unlock_censored_manual'], list : ['auto' , 'manual'], type : 'enum'},
        'unlock_unlockCensoredParser' : {name : 'censoredParser', parent : 'unlock', loc : 'unlock_censored_parser', type : 'bool', default : true},
        'unlock_unlockCensoredAuth' : {name : 'auth', parent : 'unlock', loc : 'unlock_censored_auth', type : 'bool', default : true},
        'unlock_unlockCensoredCache' : {name : 'cache', parent : 'unlock', loc : 'unlock_censored_cache', type : 'bool', default : true},
