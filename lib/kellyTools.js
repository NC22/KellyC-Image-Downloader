...
// todo - check catch implementation - callback can be passed twice ( first - successfull response - callback error, second - catch - callback error - call callback ) 
// so we need set canceled = true on success and show error in catch if already canceled
