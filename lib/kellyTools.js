...
KellyTools.setCopyright = function(id, context) {
    ...
    if (context == 'popup') html = '<a target="_blank" href="http://kelly.catface.ru/help_downloader">' + KellyLoc.s('', 'help') + '</a>© <a target="_blank" href="http://kelly.catface.ru/">' + KellyLoc.s('', 'nradiowave_person') + '</a>';
    else html = '&nbsp;&copy; <a target="_blank" href="http://kelly.catface.ru/">' + KellyLoc.s('', 'nradiowave_person')  + '</a>';
