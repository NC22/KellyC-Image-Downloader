...
KellyDPage.showAdditionFilters = function() {
    ...
    var html = '<div class="' + cl + '-statistic ' + cl + '-section-header-inline ' + cl + '-section-sidebar_section_extra_filters" data-target="sidebar_section_extra_filters">\
        ...
        html += '<div class="' + cl + '-buttons ' + cl + '-buttons-last ' + cl + '-buttons-single">\
    ...
    KellyTools.getElementByClass(container, cl + '-buttons-filter').onclick = function() {
        ...
        var boundsBtn = KellyTools.getElementByClass(container, cl + '-proportions');       
        var filterRun = function() {
            
            boundsBtn.innerText = KellyLoc.s('', 'recorder_load_prop'); 
        ...
        if (boundsRequired) {
            ...
            if (unknownBounds > 0 && !KellyDPage.aDProgress.imgLoader) {
                boundsBtn.innerText = KellyLoc.s('', 'recorder_load_prop_skip');
        ...
        */           
        ...
        KellyDPage.env.events.onExtensionReady = function() {
            ...
            var options = K_FAV.getOptionsManager();
                options.protectedOptions = ['grid_fixed', 'grid_type', 'grid_lazy', 'grid_viewerShowAs', 'grid_perPage', 'webRequest', 'newFirst', 'unlockCensored'];
