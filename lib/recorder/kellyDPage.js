...
KellyDPage.showAdditionFilters = function() {
    ...
    var html = '<div class="' + cl + '-statistic ' + cl + '-section-header-inline ' + cl + '-section-sidebar_section_extra_filters" data-target="sidebar_section_extra_filters">\
        ...
        html += '<div class="' + cl + '-bounds">' + KellyLoc.s('', 'recorder_min_dimensions') + ' : ';
            html += '<input type="text" class="' + cl +'-filter-width" placeholder="width" value=""> x <input type="text" class="' + cl + '-filter-height" placeholder="height" value="">';
        html += '</div>';
        ...
        html += '<div class="' + cl + '-url"><input type="text" class="' + cl + '-filter-url" placeholder="Match url"> <label><input type="checkbox"> ' + KellyLoc.s('Reqular expression', 'recorder_regular_expr') + '</label></div>';        
...
KellyDPage.init = function() {
     ...
     KellyDPage.env.events.onStorageAfterload = function(fav, loadType, context) {
        ...
        } else if (context == 'selectDB' && (loadType == 'items' || !loadType)) {
