...
KellyDPage.showAdditionFilters = function() {
    ...
    html += '<div class="' + cl + '-buttons ' + cl + '-buttons-single ' + cl + '-buttons-proportions">\
                <button class="' + cl + '-proportions-desc" data-sort="desc">' + KellyLoc.s('', 'recorder_load_prop_desc') + '</button>\
             </div>';
             
    html += '<div class="' + cl + '-buttons ' + cl + '-buttons-single ' + cl + '-buttons-proportions">\
                <button class="' + cl + '-proportions-asc" data-sort="asc">' + KellyLoc.s('', 'recorder_load_prop_asc') + '</button>\
             </div>';
             
    html += '<div class="' + cl + '-buttons ' + cl + '-buttons-single ' + cl + '-buttons-order">\
                <button class="' + cl + '-order-desc" data-sort="desc">' + KellyLoc.s('', 'recorder_sort_id_desc') + '</button>\
             </div>'; 
             
    html += '<div class="' + cl + '-buttons ' + cl + '-buttons-single ' + cl + '-buttons-order">\
                <button class="' + cl + '-order-asc" data-sort="asc">' + KellyLoc.s('', 'recorder_sort_id_asc') + '</button>\
             </div>';
    ...
    var proportionsSort = function() {
        ...
        var items = K_FAV.getGlobal('fav').items, sortby = this.getAttribute('data-sort'), displayed = K_FAV.getGlobal('filtered');
    ...
    var orderSort = function() {
        ...
        if (KellyDPage.aDProgress.imgLoader) return false;
