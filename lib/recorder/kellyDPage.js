...
KellyDPage.showAdditionFilters = function() {
    ...
    var html = '<div class="' + cl + '-statistic ' + cl + '-section-header-inline ' + cl + '-section-sidebar_section_extra_filters" data-target="sidebar_section_extra_filters">\
        ...
        html += '<div class="' + cl + '-buttons ' + cl + '-buttons-single ' + cl + '-buttons-proportions"><button class="' + cl + '-proportions">' + KellyLoc.s('Load proportions', 'recorder_load_prop') + '</button></div>';
    ...
    KellyDPage.aDProgress.boundsBtn = KellyTools.getElementByClass(container, cl + '-proportions');
    KellyDPage.aDProgress.relatedDocBtn = KellyTools.getElementByClass(container, cl + '-related-links');
    ...
    KellyTools.getElementByClass(container, cl + '-buttons-filter').onclick = function() {
        ...
        var filterRun = function() {
            ...
            KellyDPage.aDProgress.boundsBtn.innerText = KellyLoc.s('', 'recorder_load_prop'); 
        ...
        if (boundsRequired) {
            ...
            if (unknownBounds > 0 && !KellyDPage.aDProgress.imgLoader) {
                KellyDPage.aDProgress.boundsBtn.innerText = KellyLoc.s('', 'recorder_load_prop_skip');
    ...
    KellyDPage.aDProgress.relatedDocBtn.onclick = function() {
            ...
            if (context == 'onDownloadDocEnd') {
                ...
                if (KellyDPage.aDProgress.docLoader.docsImages.length > 0) {
                    ...
                    KellyDPage.updateUrlMap(function() {
                        KellyDPage.aDProgress.relatedDocBtn.innerText = KellyLoc.s('', 'recorder_load_prop_skip');
                    ...
                    K_FAV.dataFilterLock = false;            
                    KellyDPage.aDProgress.relatedDocBtn.innerText = KellyLoc.s('', 'recorder_load_related_doc');                       
        ...
        KellyDPage.aDProgress.relatedDocBtn.innerText = KellyLoc.s('', 'recorder_load_doc_stop');
    ...
    KellyDPage.aDProgress.boundsBtn.onclick = function() {
