...
KellyRecorderFilterPikabu.onStartRecord = function(handler, context) {
     ...
     handler.additionCats = {
        pikabu_comment : {loc : 'Comment', color : '#b7dd99'},
        pikabu_post : {loc : 'Post', color : '#b7dd99'},
     };
     ...
     if (saveFolder) handler.additionCats['pikabu_save'] = {loc : saveFolder, color : '#8ac858', selected : 120};
}
