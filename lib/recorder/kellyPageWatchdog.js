function KellyPageWatchdog(cfg) 
{
    ...
    // todo - add left | right record icon position
    ...
    function constructor(cfg) {
        if (!cfg || !cfg.url) handler.setLocation({url : window.location.href, host : window.location.hostname});
    ...
    this.setLocation = function(data) {
        ...
        this.url = data.url;
        this.host = data.host; // host used only for information purposes - maybe remove www. by default ?
