...
var KellyEDispetcher = new Object;
    ...
    KellyEDispetcher.addRequestListeners = function(tabData) {
        ...
        if (KellyTools.getBrowserName() != 'firefox') { // tabId returns -1 for firefox for content-script events, todo pay attention (limit by download items if not options page) \ send bug report
