    ...
    KellyEDispetcher.addRequestListeners = function(tabData) {
        ...
        if (tabData.referrer || tabData.urlMap) {
            ...
            tabData.onBeforeSendHeaders = function(e) {
                ...
                if (referrer) {
                    ...
                    if (getHeader(e.requestHeaders, 'If-Modified-Since')) {
                        modifyHeader('If-Modified-Since', 'Tue, 01 Jan 1980 1:00:00 GMT');
                    }
            ...
            tryAddListener('onBeforeSendHeaders', tabData.onBeforeSendHeaders, filter, ['requestHeaders', 'blocking'], true);            
        }
        ...
        if (tabData.cors) {    
            ...
            tabData.onHeadersReceived = function(e) {  
                   ...
                   if (e.statusCode == 200) modifyHeader(e.responseHeaders, 'expires', 'Tue, 01 Jan 1980 1:00:00 GMT');
    ...
    KellyEDispetcher.onMessage = function(request, sender, callback) {
        ...
        /* deprecated */
            ...
            return true; // async mode
                ...
                if (!request.type) request.type = 'css';
                request.module = request.module ? request.module + '/' : '';
                
                var loaded = 0, answerData = {notice : '',  url : '' }, loadedData = {};
                ...
                var onGetResource = function(url, data, notice) {
                    ...
                    if (callback && loaded == request.items.length) {
                        ...
                        if (!request.asObject) {
                            ...
                            answerData[request.type] = '';
                            
                            for (var i = 0; i < request.items.length; i++) {
                                answerData[request.type] += "\n\r\n\r\n\r" + '/* ' +  request.items[i] + ' */' + "\n\r\n\r\n\r" + loadedData[request.items[i]].data + "\n\r\n\r\n\r" + '/* ' +  request.items[i] + ' end */' + "\n\r\n\r\n\r";
                            }
                            
                        } else answerData[request.type] = loadedData;
                ...
                for (var i = 0; i < request.items.length; i++) {
                    ...
                    loadedData[request.items[i]] = {url : KellyTools.getBrowser().runtime.getURL(KellyEDispetcher.envDir + request.type + '/' + request.module + request.items[i] + '.' + request.type), data : false};
