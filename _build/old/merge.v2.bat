...
SET frontendStr=flist.txt
SET backgroundStr=blist.txt
...
if "%manifestVersion%" equ "3" (
    ...
    @echo.>> %background% 
    @echo "lib\kellyDispetcherNetRequest.js", >> %backgroundStr%    
...
if "%joyreactor%" geq "1" (    
    ...
    @echo.>> %background% 
    @echo "lib\profiles\joyreactor.unlock.d.js", >> %backgroundStr%    
)

@echo.>> %background%
copy %background% + "env\init\background.js" %background%
@echo.>> %background%
@echo "env\init\background.js", >> %backgroundStr%
...
if "%recorder%" geq "1" (
    ...
    @echo.>> %background%  
    @echo "lib\recorder\kellyEDRecorder.js", >> %backgroundStr%
)
