...
function KellyToolbar(cfg) {
    ...
    var handler = this;
        ...
        handler.events = {
            ...
            onDisplayBlock : function(mode, action, oldMode) {
                ...
                } else handler.container.classList.remove(handler.className + '-shown');
    ...
    this.updateCatList = function() {
         ...
         var html = getCatListHtml('Выбраны картинки', filters.catFilters, filters.logic);
    ...
    this.show = function() {
       ...
       if (!handler.container.innerHTML) {
           ...
           html = '\
                ...
                <div class="' + handler.className + '-right">\
                   ...
                   <div class="' + handler.className + '-theme"></div>\
               </div>';       
       ...
       // todo - getGlobal('read_only')
       handler.updateCatList();
    }
